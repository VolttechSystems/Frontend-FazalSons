...
//     if (searchInput.trim() === '') {
//         fetchVariations(); // If input is empty, fetch all variations
//     } else {
//         try {
//             const response = await axios.get(`http://16.170.232.76/pos/products/new_search_brand/${searchInput}`);
//             setVariations(response.data); // Update variations with search results
//         } catch (error) {
//             console.error('Error searching variations:', error);
//             setError('Failed to search variations.');
//         }
//     }
// };
