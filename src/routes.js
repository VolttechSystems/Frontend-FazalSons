...
const routes = [
  ...
  { path: '/base/POS', name: 'POS',element: 'POS', element: (props) => <AuthGuard element={POS} requiredPermission="Admin" {...props} /> }, // POS
  { path: '/base/POSTable2', name: 'POSTable2', element: 'POSTable2', element: (props) => <AuthGuard element={POSTable2} requiredPermission="product" {...props} /> }, // POSTable2
  { path: '/base/RegisterSystem', name: 'RegisterSystem', element: RegisterSystem }, // Register
  { path: '/Admin/Salesman', name: 'Salesman',element: 'Salesman', element: (props) => <AuthGuard element={Salesman} requiredPermission="Admin" {...props} /> }, // Salesman
  { path: '/Product/AllProducts/:outletId', name: 'AllProducts', element: (props) => <AuthGuard element={AllProducts} requiredPermission="product" {...props} /> }, //AllProducts
  { path: '/Product/ProductEdit/:id', name: 'ProductEdit', element: ProductEdit }, //ProductEdit
  { path: '/Product/Brands', name: 'Brands',element: 'Brands',element: (props) => <AuthGuard element={Brands} requiredPermission="product" {...props} /> }, //Brands
  { path: '/Product/AddBrands', name: 'AddBrands', element: AddBrands }, //AddBrands
  { path: '/Product/AddProduct', name: 'AddProduct', element: 'AddProduct', element: (props) => <AuthGuard element={AddProduct} requiredPermission="product" {...props} /> }, //AddProduct
  { path: '/Product/AddBrands/:id', name: 'EditBrand', element: AddBrands }, // Edit Brand
  { path: '/Product/ParentCategory', name: 'ParentCategory', element: 'ParentCategory', element: (props) => <AuthGuard element={ParentCategory} requiredPermission="product" {...props} /> }, //ParentCategory
  ...
  { path: '/Product/AddAtt', name: 'AddAtt',  element: 'AddAtt', element: (props) => <AuthGuard element={AddAtt} requiredPermission="product" {...props} /> }, //AddAtt
  ...
  { path: '/Product/Category', name: 'Category', element: 'Category', element: (props) => <AuthGuard element={Category} requiredPermission="product" {...props} /> }, //Category
  { path: '/Product/AddCategory', name: 'AddCategory', element: AddCategory }, //AddCategory
  { path: '/Product/SubCategory', name: 'SubCategory', element: 'SubCategory', element: (props) => <AuthGuard element={SubCategory} requiredPermission="product" {...props} /> }, //SubCategory
  ...
  { path: '/Stock/AddStock', name: 'AddStock',element: (props) => <AuthGuard element={AddStock} requiredPermission="stock" {...props} /> },  //AddStock
  { path: '/Customer/AddCustomer', name: 'AddCustomer', element:'AddCustomer', element: (props) => <AuthGuard element={AddCustomer} requiredPermission="Customer" {...props} /> }, //AddCustomer
  ...
  { path: '/Admin/AddOutlet', name: 'AddOutlet',element:'AddOutlet', element: (props) => <AuthGuard element={AddOutlet} requiredPermission="Admin" {...props} /> },// AddOutlet
  ...
  { path: '/Admin/AdditionalFee', name: 'AdditionalFee', element:'AdditionalFee',element: (props) => <AuthGuard element={AdditionalFee} requiredPermission="Admin" {...props} /> }, // AdditionalFee

  //Reports
  { path: '/Reports/DaySale', name: 'DaySale', element: 'DaySale', element: (props) => <AuthGuard element={DaySale} requiredPermission="Reports" {...props} /> }, //DaySale
  { path: '/Reports/SaleReport', name: 'SaleReport', element: 'SaleReport', element: (props) => <AuthGuard element={SaleReport} requiredPermission="Reports" {...props} /> }, //SaleReport
  { path: '/Reports/ProfitReport', name: 'ProfitReport', element: 'POSTable2', element: (props) => <AuthGuard element={POSTable2} requiredPermission="Reports" {...props} /> }, //ProfitReport
  { path: '/Reports/CommissionReport', name: 'CommissionReport',element: 'CommissionReport', element: (props) => <AuthGuard element={CommissionReport} requiredPermission="Reports" {...props} /> }, //CommissionReport
  { path: '/Reports/ProductReport', name: 'ProductReport',element: 'ProductReport', element: (props) => <AuthGuard element={ProductReport} requiredPermission="Reports" {...props} /> }, //ProductReport
  { path: '/Reports/PaymentReport', name: 'PaymentReport', element: 'PaymentReport', element: (props) => <AuthGuard element={PaymentReport} requiredPermission="Reports" {...props} /> }, //PaymentReport

  //Roles
  { path: '/Admin/SysRoles', name: 'SysRoles', element: 'SysRoles', element: (props) => <AuthGuard element={SysRoles} requiredPermission="Admin" {...props} /> }, // SysRoles
  { path: '/Admin/RegisterUser', name: 'RegisterUser',  element: 'RegisterUser', element: (props) => <AuthGuard element={RegisterUser} requiredPermission="Admin" {...props} /> }, // RegisterUser

  { path: '/Admin/Payment', name: 'Payment',element:'Payment',element: (props) => <AuthGuard element={Payment} requiredPermission="Admin" {...props} /> }, // Payment
]
